...
class PoseEstimator:
    ...
    def __init__(self, img_size=(480, 640), model_path=None):
        self.size = img_size
    ...
    def draw_axes(self, img, R, t):
        img	= cv2.drawFrameAxes(img, self.camera_matrix, self.dist_coeefs, R, t, 30, 1)

    def x_y_z_axes(self, R, t):
        points = np.float32(
            [[30, 0, 0], [0, 30, 0], [0, 0, 30], [0, 0, 0]]).reshape(-1, 3)

        axisPoints, _ = cv2.projectPoints(points, R, t, self.camera_matrix, self.dist_coeefs)
